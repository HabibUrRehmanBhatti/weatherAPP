navigator.geolocation.getCurrentPosition(function position(csd){
    let op = csd.coords.latitude;
    let zp = csd.coords.longitude
    console.log(op)
    console.log(zp)
    console.log(csd)
  ...
  let locatin_inp = document.getElementById("locatin_inp")
  let imag = document.getElementById("fix_img_size1")
  let hed1 = document.getElementById("he_1") 
  let hed2 = document.getElementById("he_2") 
  let hed3 = document.getElementById("he_3") 
